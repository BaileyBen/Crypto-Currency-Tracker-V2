    ...
    <div>
        <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="text-yellow-500 font-semibold w-full my-2 p-3 bg-[#3d048d] hover:text-[#6900ff] hover:bg-yellow-500 rounded-2xl shadow-xl">Sign In</button>
            </form>
            <p>Don't have an account? <Link className="text-yellow-500 hover:text-[#6900ff]" to='/signup'>Register</Link></p>
        </div>
    </div>
  )
}
